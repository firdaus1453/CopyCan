#!/bin/bash
# create_dmg.sh — Package CopyCan.app into a distributable .dmg file
#
# Usage: ./create_dmg.sh
#
# Creates CopyCan.dmg containing the .app bundle.
...
echo "  2. Drag CopyCan.app to the Applications folder"
echo "  3. Open from /Applications/CopyCan.app"
